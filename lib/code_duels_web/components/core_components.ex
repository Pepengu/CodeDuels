defmodule CodeDuelsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CodeDuelsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CodeDuelsWeb.Gettext, "errors", msg, opts)
    end
  end
